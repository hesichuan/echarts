...
import { ref, provide, computed, shallowRef, nextTick } from 'vue'
import { BorderBox11, Decoration5 } from '@dataview/datav-vue3'

import CloseBtn from '@/assets/imgs/close_btn.jpg'
...
const currentComp = computed(() => {
  if (parentComps.value === 'OrderCarousel') {
...
const init = ({
  ...
  console.log('当前组件', title, compsName, data)
